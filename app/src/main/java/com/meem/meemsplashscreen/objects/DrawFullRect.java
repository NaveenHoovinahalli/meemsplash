...
//			setMaterial(.94f,.96f,.47f,1.0f);
	...
	private void setMaterial(float r,float g,float b,float a) {
		GLES20.glUniform4f(DrawFullRect._materialAmbientHandle,r,g,b,a);
		GLES20.glUniform4f(DrawFullRect._materialDiffuseHandle,r,g,b,a);
		GLES20.glUniform4f(DrawFullRect._materialSpecularHandle,r,g,b,a);
		GLES20.glUniform1f(DrawFullRect._materialShininessHandle, 0.6f);
	}
